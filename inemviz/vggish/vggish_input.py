...
import inemviz.vggish.mel_features as mel_features
...
if __name__ == "__main__":
  wav_file = "/Volumes/HighTideSSD/_slowProteo/vggish_test/models/research/audioset/vggish/01 - Melatonia.wav"
  x = wavfile_to_examples(wav_file)
  print(x.shape)
